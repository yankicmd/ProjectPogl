...
public class ViewCommands {import javax.swing.JButton;
...
import Controller.Controller;
    ...
    class ViewCommands extends JPanel {
        ...
        public ViewCommands(Island Modeles) {
             ...
             * D'others variantes d'auditeurs pour des événements particuliers :
             ...
             */
            Controller ctrl = new Controller(Modeles);
             ...
             *
             JButton boutonAvance = new JButton(">");
             this.add(boutonAvance);
             boutonAvance.addActionListener(e -> { Modeles.avance(); });
             *
             */
